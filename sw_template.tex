...
%\reviewer{\fnms{Second} \snm{Editor}\address{\institution{First University or Company name}, \cny{Country}
%    and \institution{Second University or Company name}, \cny{Country}}}
%\end{review}
%\begin{review}{solicited}
%\reviewer{\fnms{First} \snm{Solicited reviewer}\address{\institution{University or Company name}, \cny{Country}}}
%\reviewer{\snm{anonymous reviewer}}
%\end{review}
%\begin{review}{open}
%\reviewer{\fnms{First} \snm{Open Reviewer}\address{\institution{University or Company name}, \cny{Country}}}
%\end{review}
