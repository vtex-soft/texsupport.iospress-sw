...
\author{\fnms{Second} \snm{Editor}\address{\institution{University or Company name}, \cny{Country}}}
\end{review}
\begin{review}{solicited}
\author{\fnms{First Solicited} \snm{Reviewer}\address{\institution{University or Company name}, \cny{Country}}}
\author{\fnms{Second Solicited} \snm{Reviewer}\address{\institution{University or Company name}, \cny{Country}}}
\end{review}
\begin{review}{open}
\author{\fnms{First Open} \snm{Reviewer}\address{\institution{University or Company name}, \cny{Country}}}
\author{\fnms{Second Open} \snm{Reviewer}\address{\institution{University or Company name}, \cny{Country}}}
\end{review}
