...
\begin{review}{editor}
\reviewer{\fnms{First} \snm{Editor}\address{\institution{University or Company name}, \cny{Country}}}
\reviewer{\fnms{Second} \snm{Editor}\address{\institution{University or Company name}, \cny{Country}}}
\end{review}
\begin{review}{solicited}
\reviewer{\fnms{First Solicited} \snm{Reviewer}\address{\institution{University or Company name}, \cny{Country}}}
\reviewer{\fnms{Second Solicited} \snm{Reviewer}\address{\institution{University or Company name}, \cny{Country}}}
\end{review}
\begin{review}{open}
\reviewer{\fnms{First Open} \snm{Reviewer}\address{\institution{University or Company name}, \cny{Country}}}
\reviewer{\fnms{Second Open} \snm{Reviewer}\address{\institution{University or Company name}, \cny{Country}}}
\end{review}
